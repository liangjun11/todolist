...
/* harmony import */ var _Users_liangjun_Code_poolside_node_modules_svelte_loader_lib_hot_api_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../node_modules/svelte-loader/lib/hot-api.js */ "../node_modules/svelte-loader/lib/hot-api.js");
/* harmony import */ var _Users_liangjun_Code_poolside_node_modules_svelte_hmr_runtime_proxy_adapter_dom_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../node_modules/svelte-hmr/runtime/proxy-adapter-dom.js */ "../node_modules/svelte-hmr/runtime/proxy-adapter-dom.js");
/* module decorator */ module = __webpack_require__.hmd(module);
/* src/pages/login/App.svelte generated by Svelte v4.2.18 */


const { console: console_1 } = svelte_internal__WEBPACK_IMPORTED_MODULE_0__.globals;


const file = "src/pages/login/App.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(span, "class", "loading loading-spinner");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(span, file, 35, 16, 1116);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			span = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("span");
			span.textContent = "If the name doesn't exist, a new user will be created";
			t4 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.space)();
			div1 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("div");
			button = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("button");
			if_block.c();
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(h2, "class", "card-title");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(h2, file, 17, 10, 466);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(input, "type", "text");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(input, "placeholder", "Type your username to login");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(input, "class", "input input-bordered w-full max-w-xs");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(input, file, 18, 10, 513);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(span, "class", "label-text-alt");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(span, file, 25, 12, 740);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div0, "class", "label");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div0, file, 24, 10, 708);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(button, "class", button_class_value = "btn btn-primary " + (/*isLoading*/ ctx[1] ? 'btn-disabled' : ''));
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(button, file, 30, 12, 936);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div1, "class", "card-actions justify-end");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div1, file, 29, 10, 885);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div2, "class", "card-body items-center text-center");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div2, file, 16, 8, 407);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div3, "class", "card bg-neutral text-neutral-content w-96 h");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div3, file, 15, 6, 341);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div4, "class", "flex justify-center");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div4, file, 14, 4, 301);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div5, "class", "flex flex-col justify-center h-screen");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div5, file, 13, 2, 245);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(main, file, 12, 0, 236);
		},
		...
		m: function mount(target, anchor) {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(main, div5);
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(div2, h2);
			...
			if (!mounted) {
				dispose = [
					...
					(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.listen_dev)(button, "click", /*onLoginClicked*/ ctx[2], false, false, false, false)
				];
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*isLoading*/ 2 && button_class_value !== (button_class_value = "btn btn-primary " + (/*isLoading*/ ctx[1] ? 'btn-disabled' : ''))) {
...
function instance($$self, $$props, $$invalidate) {
	...
	async function onLoginClicked() {
		...
		console.log(name);
		await window.todoActions.login(name);
	...
	$$self.$capture_state = () => ({ name, isLoading, onLoginClicked });
	...
	return [name, isLoading, onLoginClicked, input_input_handler];
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _App_svelte__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App.svelte */ "./src/pages/login/App.svelte");
